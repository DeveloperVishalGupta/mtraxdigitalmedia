                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    {filter &&
                        <div class="flex justify-center flex-wrap gap-4 mb-12">
                            <button name='all filter' class="filter-btn active bg-rose-500 text-white px-6 py-2 rounded-full hover:bg-rose-600 transition-colors" data-filter="all">
                                All
                            </button>
                            <button name='Hair filter' class="filter-btn bg-neutral-200 text-neutral-700 px-6 py-2 rounded-full hover:bg-rose-500 hover:text-white transition-colors" data-filter="hair">
                                Hair
                            </button>
                            <button name='Makeup filter' class="filter-btn bg-neutral-200 text-neutral-700 px-6 py-2 rounded-full hover:bg-rose-500 hover:text-white transition-colors" data-filter="makeup">
                                Makeup
                            </button>
                            <button name='Nails filter' class="filter-btn bg-neutral-200 text-neutral-700 px-6 py-2 rounded-full hover:bg-rose-500 hover:text-white transition-colors" data-filter="nails">
                                Nails
                            </button>
                        </div>
                    }
                                        ...
                                        <Card className="items-center " style={partnersCardStyle}>
                                            <CardBody className="overflow-visible">
                                                <Image
                                                    ...
                                                    className='w-full max-w-44 h-auto mx-auto'
                                                />
                                            </CardBody>
